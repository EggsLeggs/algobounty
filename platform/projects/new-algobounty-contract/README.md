# new-algobounty-contract

This project contains the AlgoBounty smart contracts built with AlgoKit. The primary contract, `BountyEscrow`, manages per-issue escrow pots so the dapp can accept ALGO deposits, track totals, and release funds to vetted claimants when GitHub issues close. See below for default getting started instructions.
